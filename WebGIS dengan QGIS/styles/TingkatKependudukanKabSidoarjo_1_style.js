...
var style_TingkatKependudukanKabSidoarjo_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Jumlah_Penduduk_Jumlah_Penduduk");
    ...
    if (value >= 651.880000 && value <= 1883.944000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1883.944000 && value <= 2557.580000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2557.580000 && value <= 3131.500000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3131.500000 && value <= 4832.740000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4832.740000 && value <= 6310.330000) {
            style = [ new ol.style.Style({
